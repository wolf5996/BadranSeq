...
turns a `clusterProfiler` GSEA result into a publication-ready
horizontal barplot. Unlike a dotplot, it clearly shows the direction and
magnitude of NES, and labels each bar with its adjusted p-value and
leading-edge genes:
...
![](reference/figures/README-gsea-example-1.png)
...
| [`do_GseaPlot()`](https://wolf5996.github.io/BadranSeq/reference/do_GseaPlot.md) | GSEA barplot with diverging NES and readable gene labels |
